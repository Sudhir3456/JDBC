...
public class UpdateEmplyoeeSalaryController {
	...
	public static void main(String[] args) {
		...
		try {
			...
			// Step4- Execute Query
			String updateEmployeeSalary = "update employee set salary=salary+1.05 where salary>=30000";

			int satus = statement.executeUpdate(updateEmployeeSalary);

			if (satus != 0) {

				System.out.println("Updated data from the table");
